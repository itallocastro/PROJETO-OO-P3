...
public class AdicionarTarefas extends javax.swing.JFrame {
    ...
    private ArrayList<ListaTarefas> all_tasks = new ArrayList<>();
    
    
    
    
    
    public ArrayList<ListaTarefas> retorna_tarefas()
    {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addComponent(jTipos, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAddActionPerformed
       ...
       boolean correct;
        ...
        {
            ListaTarefas novo_estudo = new ListaTarefasEstudos(jNomeTarefa.getText(),String.valueOf(jTipos.getSelectedItem()),String.valueOf(jMaterias.getSelectedItem()),jData.getText());
            
            all_tasks.add(novo_estudo);           
             JOptionPane.showMessageDialog(null, "Adicionado com sucesso!");
        }
        else if(tipo.equals("Trabalho") && (!jNomeTarefa.getText().equals("")))
        {
            ListaTarefas nova_tarefa = new ListaTarefasTrabalho(jNomeTarefa.getText(),String.valueOf(jTipos.getSelectedItem()),jData.getText());
            all_tasks.add(nova_tarefa);
            JOptionPane.showMessageDialog(null, "Adicionado com sucesso!");
        }
        else if(tipo.equals("Lazer") && (!jNomeTarefa.getText().equals("")))
        {
            ListaTarefas novo_lazer = new ListaTarefasLazer(jNomeTarefa.getText(),String.valueOf(jTipos.getSelectedItem()),jData.getText());
            all_tasks.add(novo_lazer);
            JOptionPane.showMessageDialog(null, "Adicionado com sucesso!");
        }
        jNomeTarefa.setText("");
